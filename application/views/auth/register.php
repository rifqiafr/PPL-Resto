...
<head>
    ...
    <!-- Main CSS-->
    <link href="<?php echo get_theme_uri('custom/auth/register/css/csscustome.css'); ?>" rel="stylesheet" media="all">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('auth/register/verify'); ?>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-2" type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" placeholder="No. HP" minlength="9" maxlength="15" name="phone_number" value="<?php echo set_value('phone_number'); ?>" required>
                        ...
                        <a class="link" href="<?php echo site_url('auth/login'); ?>">Sudah Punya akun ?</a>
                        <div class="p-t-30">
