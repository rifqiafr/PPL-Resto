      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="h2footer"><?php echo get_store_name(); ?></h2>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              <h2 class="h2footer">Punya Pertanyaan?</h2>
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="<?php echo site_url('pages/contact'); ?>"><span class="icon icon-envelope"></span><span class="text"><?php echo get_settings('store_email'); ?></span></a></li>
                </ul>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved  <span style="color: #00A9FF">| Lesehan Raihan</span>
