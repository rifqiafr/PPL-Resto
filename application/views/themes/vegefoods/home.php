...
<section id="home-section" class="hero">
  <div class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg-main1.jpg'); ?>);">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Harga Mahasiswa</h1>
            <h2 class="subheading mb-4">Murah, Banyak, Kenyang</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div> -->
      ...
      <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            <h3 class="heading">Pelayanan Ramah</h3>
            <span>Senyum Sapa Salam</span>
          </div>
        </div>
      </div>
      <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            ...
            <span>Di Olah Dengan Bahan-Bahan yang Berkualitas</span>
          </div>
        </div>
      </div>
      <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            ...
            <span>Aman Di Kantong Mahasiswa</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-3 pb-3">
      <div class="col-md-12 heading-section text-center ftco-animate">
        <span class="subheading">Makanan Mahasiswa</span>
    ...
    <div class="row justify-content-end">
      <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
        ...
        <div id="timer" class="d-flex mt-5">
          <div class="time pl-3">
          <a href="#" class="btn btn-primary add-cart" data-sku="<?php echo $best_deal->sku; ?>" data-name="<?php echo $best_deal->name; ?>" data-price="<?php echo $best_deal->price; ?>" data-id="<?php echo $best_deal->id; ?>"><i class="ion-ios-cart"></i></a>
          </div>
          <div class="time pl-3">
