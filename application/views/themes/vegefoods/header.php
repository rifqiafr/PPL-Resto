...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo get_theme_uri('css/flaticon.css'); ?>">
		<link rel="stylesheet" href="<?php echo get_theme_uri("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css");?>">
    <link rel="stylesheet" href="<?php echo get_theme_uri('css/icomoon.css'); ?>">
	<link rel="stylesheet" href="<?php echo get_theme_uri('css/style1.css'); ?>">
	<link rel="stylesheet" href="<?php echo get_theme_uri('css/csscustome.css'); ?>">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li <?=$this->uri->segment(1)==''?' class="nav-item active"' : 'class="nav-item"' ?>><a href="<?php echo base_url(); ?>" class="nav-link">Home</a></li>
	          ...
	          <li <?=$this->uri->segment(2)=='about'?' class="nav-item active"' : 'class="nav-item"' ?>><a href="<?php echo site_url('pages/about'); ?>" class="nav-link">Tentang Kami</a></li>
              <li <?=$this->uri->segment(2)=='contact'?' class="nav-item active"' : 'class="nav-item"' ?>><a href="<?php echo site_url('pages/contact'); ?>" class="nav-link">Kontak</a></li>
              <li class="nav-item dropdown">
