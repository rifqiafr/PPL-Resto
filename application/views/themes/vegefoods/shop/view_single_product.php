          ...
          <div class="row">
              ...
              <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                  ...
                  <!-- <div class="rating d-flex">
                          ...
                          <p class="text-left mr-4">
                              <a href="#" class="mr-2" style="color: #ffffff;">100 <span style="color: #bbb;">Rating</span></a>
                          </p>
                          <p class="text-left">
                              <a href="#" class="mr-2" style="color: #ffffff;">500 <span style="color: #bbb;">Sold</span></a>
                          </p>
                      </div> -->
                  <p class="price">
                ...
                <div class="w-100"></div>
                <div class="col-md-12">
                    <p style="color: #4dae3c;">Tersedia <?php echo $product->stock; ?> <?php echo $product->product_unit; ?></p>
                </div>
            </div>
