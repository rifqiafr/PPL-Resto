          ...
          <div class="card bg-default">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-light text-uppercase ls-1 mb-1">Selamat Datang</h6>
                  <h5 class="h3 text-white mb-0">di Lesehan Raihan</h5>
                  <img src="<?php echo base_url('assets/uploads/users/welcome.jpg'); ?>" alt="Welcome Image" class="img-fluid mt-3">
                </div>
              </div>
            </div>
            <div class="card-body">
