         ...
         <div class="collapse navbar-collapse" id="sidenav-collapse-main">
           ...
           <ul class="navbar-nav">
             <li <?=$this->uri->segment(2)==''?' class="nav-item active"' : 'class="nav-item"' ?>>
               ...
               <i class="fas fa-solid fa-home text-primary"></i>
                 <span class="nav-link-text">Dashboard</span>
               </a>
             </li>
             <li <?=$this->uri->segment(3)=='category' ?' class="nav-item active"' : 'class="nav-item"' ?>>
            ...
            <li <?=$this->uri->segment(2)=='orders'?' class="nav-item active"' : 'class="nav-item"' ?>>
              <a class="nav-link" href="<?php echo site_url('admin/orders'); ?>">
              <i class="fa fa-solid fa-utensils text-danger"></i>
            ...
            <li <?=$this->uri->segment(2)=='customers' ?' class="nav-item active"' : 'class="nav-item"' ?>>
              <a class="nav-link" href="<?php echo site_url('admin/customers'); ?>">
                <i class="fa fa-users text-primary"></i>
                <span class="nav-link-text">Pelanggan</span>
              </a>
            </li>
            <li <?=$this->uri->segment(2)=='reviews' ?' class="nav-item active"' : 'class="nav-item"' ?>>
              <a class="nav-link" href="<?php echo site_url('admin/reviews'); ?>">
                <i class="fa fa-edit text-info"></i>
                <span class="nav-link-text">Review Pelanggan</span>
              </a>
            </li>
            <li <?=$this->uri->segment(2)=='contacts' ?' class="nav-item active"' : 'class="nav-item"' ?>>
