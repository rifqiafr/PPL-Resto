  ...
  <aside class="main-sidebar sidebar-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo site_url('customer/profile'); ?>" class="d-block">Selamat Datang, <br><?php echo get_user_name(); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            ...
            <?=$this->uri->segment(1)=='customer'&&$this->uri->segment(2)=='' ?' class="nav-link active"' : 'class="nav-link"' ?>>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/orders'); ?>" 
            <?=$this->uri->segment(2)=='orders' ?' class="nav-link active"' : 'class="nav-link"' ?>>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/payments'); ?>" 
            <?=$this->uri->segment(2)=='payments' ?' class="nav-link active"' : 'class="nav-link"' ?>>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/reviews'); ?>"
            <?=$this->uri->segment(2)=='reviews' ?' class="nav-link active"' : 'class="nav-link"' ?>>
